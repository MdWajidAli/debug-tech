...
const courses = [
  { name: "Full Stack", link: "/courses/full-stack" },
  { name: "Cybersecurity", link: "/courses/cybersecurity" },
  { name: "Data Analysis / Data Science", link: "/courses/data-science" },
  { name: "Service Now", link: "/courses/service-now" },
  { name: "AWS, Azure / DevOps", link: "/courses/devops" },
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="flex flex-col items-start">
            ...
            <p className="text-sm mb-2">debugtech@gmail.com</p>
            <p className="text-sm">+ 101 864821353245</p>
          </div>
          <div>
